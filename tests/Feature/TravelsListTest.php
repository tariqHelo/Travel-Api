...
class TravelsListTest extends TestCase
{
    ...
    public function test_travels_list_returns_pagination(): void
    {
        ...
        Travel::factory(16)->create(['is_published' => true]);
    ...
    //     $nonPublicTravel = Travel::factory()->create(['is_published' => false]);
    //     $publicTravel = Travel::factory()->create(['is_published' => true]);
