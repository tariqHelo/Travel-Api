...
class ToursListTest extends TestCase
{
    ...
    public function test_tours_list_by_travel_slug_returns_correct_tours_with_filters(): void
    {
        $travel = Travel::factory()->create();
        $tour = Tour::factory()->create([
            'travel_id' => $travel->id,
        ...
        $response = $this->get('/api/v1/travels/' . $travel->slug . '/tours?priceFrom=123&priceTo=124&dateFrom=2021-01-01&dateTo=2021-01-10');
